...
// -------------------------- Asm functions ----------------------------------------------
/* Функция sprXYtoHL вычисления адреса на экране по координатам
 * Вход:
 *	L=x, H=y
 * Выход:
...
/*
 * Функция sprXYtoHLattr вычисления адреса на экране по координатам
 * Вход:
 *	L=x, H=y
 * Выход:
...
/* Функция вычисления адреса экранной линии на одну ниже
 *
 * вход:
 *	HL=адрес экранной линии n-й
 * выход:
 *	HL= адрес экранной линии на одну ниже n-й 
 *
 * * Вызов:
 * 	сall scr_down_hl
 */
